...
namespace _30080193.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Latitude,Longitude")] Locations locations)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,Latitude,Longitude")] Locations locations)
        {
            if (ModelState.IsValid)
            {
